...
class LLMGenerator:
    ...
    def constrained_generator(self, inputs):
        ...
        if self.server == "llama.cpp":
            ...
            #                        
            #                      "properties": {
            #                            "name": "constrained_topic",
            #                              "topic":{"type":"string", 
            #                                       "enum":self.response_categories #["cat1","cat2","cat3"]
            #                                       },
            #                      },
            #                      "required":["topic"],
            #                    }],
    ...
    def unconstrained_generator(self, inputs):
        if self.server == "transformers":
            ...
            # Remove the input text from the beginning of the output
    ...
    #def get_device(self):
    #    """Getter method to retrieve device of the model"""
