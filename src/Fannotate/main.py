...
def run_benchmark(server, models, datasets, replications=10, test_modes=["unconstrained"],
                  temperatures=[0.75], max_task_tokens=[2500], prompts=None, suffix="",
                  refine=[False], seed=True):
    """
